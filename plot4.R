...
#plot nr 4
png(file = "plot4.png", width = 480, height = 480, bg ="dark grey")
par (mfrow = c(2,2))
with(power_consumption1,{
  plot(DateTime, Global_active_power, type ="line", xlab = "", ylab = "Global Active Power")
  plot(DateTime,Voltage,type ="line", xlab = "datetime")
  ...
  plot(DateTime,Global_reactive_power,type ="line", xlab = "datetime", ylab = "Global_reactive_power")
